...
pub fn draw(f: &mut Frame, app: &mut App) {
    ...
    match app.mode {
        ...
        Mode::NewSession => draw_input_popup(f, app, "New Session (title)", size),
...
fn draw_notes_panel(f: &mut Frame, app: &mut App, area: Rect) {
    ...
    let text = if app.notes_content.is_empty() {
...
fn draw_status_bar(f: &mut Frame, app: &App, area: Rect) {
    ...
    let keybinds = match app.mode {
        Mode::Normal => "n:new Q:quick /:search r:run e:edit p:preview ?:help q:quit",
...
fn draw_help_popup(f: &mut Frame, area: Rect) {
    ...
    let help_text = Text::from(vec![
        ...
        Line::from(vec![
            ...
            Span::raw("        Edit notes externally"),
        ]),
        Line::from(vec![
